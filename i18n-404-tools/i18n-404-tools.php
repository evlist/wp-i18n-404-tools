...
add_action('init', function() {
    if (
        ...
        require_once plugin_dir_path(__FILE__) . 'admin/class-ajax-router.php';
...
add_filter('plugin_action_links', function($actions, $plugin_file) {
    if ( current_user_can('manage_options') ) {
        $actions['i18n_pot'] = '<a href="#" class="i18n-404-tools-generate-pot" data-plugin="' . esc_attr($plugin_file) . '" data-command="generate_pot">' . esc_html__('Generate .pot', 'i18n-404-tools') . '</a>';
    }
    return $actions;
}, 10, 2);
